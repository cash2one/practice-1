...
INSERT INTO `cn_admin` VALUES('1','qmadmin','c5358a6db37949d725ae280082a99a4a','9','0','','','2018-01-29 08:56:55','182.150.133.15','766','01ebcab5bde4691766028d2998a1a7b6','','','','0','0','主站','','','','0','0');
...
INSERT INTO `cn_info` VALUES('14','0','刘小智','','','0','2',',0,2,2','客户主管','专家级管理师专家级管理师专家级管理师专家级管理师','','','','1','5','2018-01-25 10:14:56','/pub/qm/p/image/180125/021642_860.png','/pub/qm/p/image/180125/021642_860_th.png','','','','0','','0','1','1','0','','8年','皮肤诊疗','','','','','13,10','','admin','美丽莎皮肤管理中心','','0.0','0','0','0','0','0','0','0.00','0','专家级管理师','','/pub/qm/p/image/180125/021737_431.jpg,/pub/qm/p/image/180125/021928_346.jpg','','','','0','/team/14.html','0','0');
--
-- 表的结构cn_info_copy
--
...
INSERT INTO `cn_member` VALUES('7','0','18081029908','1','18081029908','','1','1515139149','http://wx.qlogo.cn/mmopen/vi_32/A4XhUDJpmLg2e3yz1If3xqbnxnflzPyGbpzbVx8X24eT1OiaNrM7ODE9pS6FIsCgLENSFwBibCDgN4sbgJFj44MQ/0','','13ed46c1bb9365f1c611871dafaffa74','1515118059','1','','羽毛','','四川 成都','','','','3','羽毛','oLCgv0g_pELowJK4srRzJfphpAvo','0','http://wx.qlogo.cn/mmopen/vi_32/A4XhUDJpmLg2e3yz1If3xqbnxnflzPyGbpzbVx8X24eT1OiaNrM7ODE9pS6FIsCgLENSFwBibCDgN4sbgJFj44MQ/132','0','','男','男','118.113.56.65','0','','','','1516935522','','0','0.0000000000000','0.0000000000000','','','','','','0','0');
...
CREATE TABLE `cn_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='订单记录表';
...
INSERT INTO `cn_order` VALUES('3','0','1','1','1-20180117024029','2','1','776.00','0','0.00','776.00','0','0','1516171229','1','1516171229','','购买2个产品测试','','0','0','管家','13594333241','0');
INSERT INTO `cn_order` VALUES('4','0','1','6','6-20180125102318','2','2','776.00','0','0.00','776.00','0','0','1516846998','1','0','','','','0','0','管家2','13594333242','0');
INSERT INTO `cn_order` VALUES('5','0','1','7','7-20180125104254','4','4','1552.00','0','0.00','1552.00','0','0','1516848174','1','0','','','','0','0','','18081029908','0');
INSERT INTO `cn_order` VALUES('6','0','1','7','7-20180125104549','20','20','7760.00','0','0.00','7760.00','0','0','1516848349','1','0','','','','0','0','','18081029908','0');
INSERT INTO `cn_order` VALUES('7','0','1','7','7-20180125104655','20','20','7760.00','0','0.00','7760.00','0','0','1516848415','1','0','','','','0','0','','18081029908','0');
INSERT INTO `cn_order` VALUES('8','0','1','7','7-20180125105352','21','18','8148.00','0','0.00','8148.00','0','0','1516848832','1','1516859904','','','','0','0','','18081029908','0');
--
-- 表的结构cn_order_goods
--
...
CREATE TABLE `cn_order_goods` (
  ...
  `del` tinyint(1) DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='订单下单明细表';
...
CREATE TABLE `cn_order_yuyue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单购买产品预约表和预约技师记录表';
...
CREATE TABLE `cn_user` (
  ...
  `audit` tinyint(1) DEFAULT '1' COMMENT '有效用户 0表示黑名单用户',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=608 DEFAULT CHARSET=utf8 COMMENT='访问者记录表';
