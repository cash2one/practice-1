...
INSERT INTO `cn_order` VALUES('9','0','1','7','7-20180129024936','21','21','8148.00','0','0.00','8148.00','0','0','1517208576','1','1517219649','','','','0','0','','18081029908','0');
--
-- 表的结构cn_order_goods
--
...
CREATE TABLE `cn_user` (
  ...
  `audit` tinyint(1) DEFAULT '1' COMMENT '有效用户 0表示黑名单用户',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=648 DEFAULT CHARSET=utf8 COMMENT='访问者记录表';
