...
class Query
{
     ...
     * @return mixed
     */
    public function getField($field, $default = null, $force = false)
    {
        return $this->value($field, $default,$force);
    }
    ...
    public function add(array $data, $replace = false, $sequence = null)
    {
        return $this->insert($data, $replace, true, $sequence);
    }
    /**
