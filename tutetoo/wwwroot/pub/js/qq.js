$(function(){
	...
	{		
		$('.onlineService').hide();
		$('.box_os').show();
		$.cookie("onlineSP","0",{expires:1,path:"/",domain:"www.tutetu.com"});		
	});
	$('.os_x').click(function()
	{
		$('.box_os').hide();
	...
	$boxOsFun = function(){var st=$(document).scrollTop();if (!window.XMLHttpRequest) {$('.box_os').css('top',st+144);$('.onlineService').css('top',st+144);}};
