 ...
 */
//申请到的appid
$_SESSION["appid"]    = 1231231231;//101328503;//100330156;

//申请到的appkey
$_SESSION["appkey"]   = "affe193cabd5bb8b48d01aef501a0ebe";//"e184b2f2d2a12bc8f24cc551b6e80bff"; 

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
$_SESSION["callback"] = "http://wifiauth.zhangkongbao.com";//"http://www.webpluz.org/sdk/Connect1.5/oauth/get_access_token.php"; 
