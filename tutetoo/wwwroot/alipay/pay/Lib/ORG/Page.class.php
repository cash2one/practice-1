...
class Page extends Think {
    ...
    public function show($para) {
		...
		//首页 上一页
		if($this->nowPage==1){
			$firstPage="<a href='javascript:void(0)' class='btn'>{$firsttext}</a>";
			$prevPage="<a href='javascript:void(0)' class='btn'>{$prevtext}</a>";
		}else{
			$firstPage="<a href='{$pageUrl}=1' class='btn'>{$firsttext}</a>";
			$prevPage="<a href='{$pageUrl}={$upRow}' class='btn'>{$prevtext}</a>";
		}
		...
		if($this->totalPages<=10)
		 {
			...
			{
				$currnt=($i==$this->nowPage)?" class='btn active'":' class="btn"';
		...
		*/
		...
		{	
		    $nextPage="<a href='javascript:void(0)' class='btn'>$nexttext</a>" ;
			$lastPage="<a href='javascript:void(0)' class='btn'>$lasttext</a>";
		}else{
		 	$nextPage="<a href='{$pageUrl}=".$downRow."' class='btn'>$nexttext</a>";
			$lastPage="<a href='{$pageUrl}={$this->totalPages}' class='btn'>$lasttext</a>";
		}
