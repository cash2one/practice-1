...
abstract class Action {
   ...
   /**
	...
	//$id = I('get.id','');
	public function srequest($input)
	{
		return $this->_post($input,'htmlspecialchars,strip_tags');	
	}
	public function srequest2($input)
	{
		return $this->_get($input,'htmlspecialchars,strip_tags');	
	}
	public function srequest3($input)
	{
		return $this->_cookie($input,'htmlspecialchars,strip_tags');	
	}
	public function srequest4($input)
	{
		return $this->_session($input,'htmlspecialchars,strip_tags');	
	}
    /**
     * 是否AJAX请求
     * @access protected
