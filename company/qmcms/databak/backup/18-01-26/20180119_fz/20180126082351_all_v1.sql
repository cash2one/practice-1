...
INSERT INTO `qm_info` VALUES('47','二氧化氯消毒器','','','0','16',',0,2,16','','<p>\r\n	<img alt=\\\"\\\" src=\\\"/pub/qm/p/image/180126/075112_224.jpg\\\"> \r\n</p>\r\n<br>\r\n<p>\r\n	<span style=\\\"color:#333333;font-size:16px;\\\"><strong>设备简介：</strong></span> <br>\r\n<span style=\\\"font-size:16px;\\\"> 二氧化氯发生器是一种集化学反应、精密计量、精确电子控制、闭环电子监视系统为一体的精密可靠的高科技产品，整个系统主要由精密计量泵、反应器及流量监视系统组成，采用整机集成为一体的集成安装方式，因此结构紧凑，安装方便，性能可靠，维护容易。广泛应用于钦用水、医院污水、城市污水、工业循环水、化工环保废水、水产养殖、纸浆生产、家禽宰杀、室内空气、啤酒制造、食品加工、泳池水循环、器具洗涤等众多领域的杀菌、消毒、灭藻、剥泥、漂白、脱色、除臭、氧化、防腐、保鲜、抗霉、破氰、破酚等。使用二氧化氯消毒剂杀菌有以下优点： A、快速持久B、安全无毒C、广谱高效D、无二次污染E、不受PH值影响 </span><br>\r\n<span style=\\\"color:#333333;font-size:16px;\\\"> <strong>二氧化氯发生器的应用范围：</strong></span><br>\r\n<span style=\\\"font-size:16px;\\\"> 1、各种场合下的生活、饮用、自来水的消毒； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 2、餐厅、宾馆、家庭、餐具卫生设施的灭菌消毒和空气环境消毒等。 </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 3、食品、饮料厂、发酵工业的设备、管道、容器的最终灭菌消毒。 </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 4、乳品厂、屠宰场的管道、设施及环境的灭菌处理； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 5、医院污水的灭菌消毒处理； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 6、游泳池、工业循环水、浴池水的灭菌消毒； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 7、医院、卫生、临床器械的消毒、灭菌、除臭的防霉处理； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 8、家庭、宾馆、饭店、水果蔬菜、鱼肉等食品的保鲜及最终淋洗消毒； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 9、配置各种口腔消毒液、除臭剂及创口清洗液等。 </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 10、废水回用中的灭菌及脱臭； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 11、面粉与各种食品的漂白剂； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 12、造纸、印染行业的漂白药剂； </span><br>\r\n<span style=\\\"font-size:16px;\\\"> 13、电镀含氰废水的破氰处理、印染废水的脱色处理，工业徨冷却水的除藻灭菌处理。</span>\r\n</p>','','','','1','15','2018-01-26 15:45:35','/pub/qm/p/image/180126/075112_224.jpg','/pub/qm/p/image/180126/075112_224_th.jpg','','','','0','','0','1','1','0','','','','','','','','','','百芳岁环保','admin','','0.0','0','0','0','0','0','','','','','','','0','/product/list-16/47.html','0');
--
-- 表的结构qm_lm
--
