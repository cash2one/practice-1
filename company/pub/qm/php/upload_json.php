...
//$save_path=BASE_PATH."pub/pic/";
//$save_path=str_replace('pub/qm/php/','',$root_path);
//文件保存目录URL
//$save_url='/pub/pic/';
//echo $save_url;
//定义允许上传的文件扩展名
$ext_arr = array(
	'image' => array('gif', 'jpg', 'jpeg', 'png', 'bmp','mp4','doc', 'docx', 'xls', 'xlsx', 'ppt', 'htm', 'html', 'txt', 'zip', 'rar', 'gz', 'bz2','pdf'),
	'flash' => array('swf', 'flv'),
	'media' => array('flv', 'mp3', 'wav', 'wma', 'wmv', 'mid', 'avi', 'mpg', 'asf', 'rm', 'rmvb','mp4'),
	'file' => array('doc', 'docx', 'xls', 'xlsx', 'ppt', 'htm', 'html', 'txt', 'zip', 'rar', 'gz', 'bz2','pdf','mp4'),
);
//最大文件大小
$max_size = 50000000;
